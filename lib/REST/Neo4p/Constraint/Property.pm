#$Id: Property.pm 461 2014-07-02 02:48:16Z maj $
...
BEGIN {
  $REST::Neo4p::Constraint::Property::VERSION = '0.2254';
}
...
use warnings;
BEGIN {
  $REST::Neo4p::Constraint::NodeProperty::VERSION='0.2254';
}
...
BEGIN {
  $REST::Neo4p::Constraint::RelationshipProperty::VERSION='0.2254';
}
