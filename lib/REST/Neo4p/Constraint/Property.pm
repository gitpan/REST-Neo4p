#$Id: Property.pm 486 2014-07-15 01:32:47Z maj $
...
BEGIN {
  $REST::Neo4p::Constraint::Property::VERSION = '0.3002';
}
...
use warnings;
BEGIN {
  $REST::Neo4p::Constraint::NodeProperty::VERSION='0.3002';
}
...
BEGIN {
  $REST::Neo4p::Constraint::RelationshipProperty::VERSION='0.3002';
}
